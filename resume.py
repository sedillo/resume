...
md_out = os.environ.get('RESUME_MD_OUT', 'out/README.md')

# Gemini
gmi_template = os.environ.get('RESUME_GMI_TEMPLATE', 'resume.gmi')
gmi_out = os.environ.get('RESUME_GMI_OUT', 'out/resume.gmi')

# Plain Text
txt_template = os.environ.get('RESUME_TXT_TEMPLATE', 'resume.txt')
txt_out = os.environ.get('RESUME_TXT_OUT', 'out/resume.txt')

# Plain Text - narrow width (for Gopher, mobile)
narrow_txt_template = os.environ.get('RESUME_TXT_NARROW_TEMPLATE', 'resume-narrow.txt')
narrow_txt_out = os.environ.get('RESUME_TXT_NARROW_OUT', 'out/resume-narrow.txt')

# JSON
json_out = os.environ.get('RESUME_JSON_OUT', 'out/resume.json')
# -----------------------------------------------------------------------------
